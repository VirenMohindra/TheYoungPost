...
function quindo_scripts_and_styles() {
    ...
    if (!is_admin()) {
        ...
        // Register Styles
        wp_enqueue_style( 'fonts', "http://fonts.googleapis.com/css?family=Tinos:400,700,400italic|Raleway:300,900" );
...
function quindo_head(){
    ?>
    <div class="dn"><?php include(dirname(__FILE__) . '/../img/pro/svg-defs.svg'); ?></div>
    <?php
}
